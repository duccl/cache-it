...
{
    public class SuperWeatherCustom : ICacheable
    {
        private readonly ILogger<SuperWeatherCustom> _logger;
        private DateTime _lastUpdate = DateTime.MinValue;
        private List<string> Summaries;

        public SuperWeatherCustom(ILogger<SuperWeatherCustom> logger)
        {
            _logger = logger;
        }
